...
<body class="home">
 <div id="page">
  <div id="header">
   ...
   <h1><a href="<?php Site::out_url( 'habari' ); ?>"><img src="<?php Site::out_url( 'theme' ); ?>/images/header.jpg" alt="<?php Options::out( 'title' ); ?>"></a></h1>
   <p class="description"><?php Options::out( 'tagline' ); ?></p>

   <ul class="menu">
    <li <?php if($request->display_home) { ?>
	class="current_page_item"<?php } ?>><a href="<?php Site::out_url( 'habari' ); ?>" title="<?php Options::out( 'title' ); ?>"><?php echo $home_label; ?></a></li>
<?php
// Menu tabs
